    ...
    for kind in range(prop_type['kinds']):
        for element in range(prop_type['number']):
            ...
            if prop_type['prototype_variety'] == 'so':
                ...
                counter = 0
                # select two to be different and the others to be same. 
                random.shuffle(dimensions)
                # select two values for same. 
                same_val1 = round(random.random()*100)+1
                same_val2 = round(random.random()*100)+1
                # select four values for different. 
                dif_val1 = round(random.random()*100)+1
                dif_val2 = dif_val1
                while dif_val2 == dif_val1:
                    dif_val2 = round(random.random()*100)+1
                dif_val3 = round(random.random()*100)+1
                dif_val4 = dif_val3
                while dif_val4 == dif_val3:
                    dif_val4 = round(random.random()*100)+1
                dif_val5 = round(random.random()*100)+1
                dif_val6 = dif_val5
                while dif_val6 == dif_val5:
                    dif_val6 = round(random.random()*100)+1
                # make the RBs. 
                counter = 1
                for RB in new_sym_dict['RBs']:
                    ...
                    vital_sem.append([dimensions[0], 1, dimensions[0], 'nil', 'state'])
                    vital_sem.append([dimensions[0]+str(same_val1), 1, dimensions[0], same_val1, 'value'])
                    vital_sem.append([dimensions[1], 1, dimensions[1], 'nil', 'state'])
                    if counter%2 != 0:
                        vital_sem.append([dimensions[1]+str(dif_val1), 1, dimensions[1], dif_val1, 'value'])
                    else:
                        vital_sem.append([dimensions[1]+str(dif_val2), 1, dimensions[1], dif_val2, 'value'])
                    vital_sem.append([dimensions[2], 1, dimensions[2], 'nil', 'state'])
                    vital_sem.append([dimensions[2]+str(same_val2), 1, dimensions[2], same_val2, 'value'])
                    vital_sem.append([dimensions[3], 1, dimensions[3], 'nil', 'state'])
                    if counter%2 != 0:
                        vital_sem.append([dimensions[3]+str(dif_val3), 1, dimensions[3], dif_val3, 'value'])
                    else:
                        vital_sem.append([dimensions[3]+str(dif_val4), 1, dimensions[3], dif_val4, 'value'])
                    vital_sem.append([dimensions[4], 1, dimensions[4], 'nil', 'state'])
                    if counter%2 != 0:
                        vital_sem.append([dimensions[4]+str(dif_val5), 1, dimensions[4], dif_val5, 'value'])
                    else:
                        vital_sem.append([dimensions[4]+str(dif_val6), 1, dimensions[4], dif_val6, 'value'])
