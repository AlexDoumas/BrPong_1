    ...
    for kind in range(prop_type['kinds']):
        for element in range(prop_type['number']):
            ...
            if prop_type['prototype_variety'] == 'so':
                ...
                same_val1 = round(random.random()*9)+1
                same_val2 = round(random.random()*9)+1
                # select four values for different. 
                dif_val1 = round(random.random()*9)+1
                dif_val2 = dif_val1
                while dif_val2 == dif_val1:
                    dif_val2 = round(random.random()*9)+1
                dif_val3 = round(random.random()*9)+1
                dif_val4 = dif_val3
                while dif_val4 == dif_val3:
                    dif_val4 = round(random.random()*9)+1
                dif_val5 = round(random.random()*9)+1
                dif_val6 = dif_val5
                while dif_val6 == dif_val5:
                    dif_val6 = round(random.random()*9)+1
                # make the RBs. 
                counter = 1
