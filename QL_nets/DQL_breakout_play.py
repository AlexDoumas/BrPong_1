    ...
    for time_step in xrange(20000):
        ...
        if is_done:
            ...
            print("episode: {}/{}, return: {}"
                  .format(episode, 100, episode_return))
...
# with open("DQN_test_generalization_to_Breakout.txt", "w") as output:
#     output.write(str(returns))

# Test with a 100 games:
# mean: 105.83, sd: 69.041, max: 315.0

# Generalization: 100 games of Breakout with Pong weights.
# mean: 0.16, max: 2.0
