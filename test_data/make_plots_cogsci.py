...
rects3 = ax1.bar(index + bar_width*2, means_DORAc, bar_width, alpha=opacity, color=c[3], label='CLEVR_DORA',yerr=std_DORAc, edgecolor = 'k')
rects4 = ax1.bar(index + bar_width*3, means_DQN, bar_width, alpha=opacity, color=c[13], label='DQN', yerr = std_DQN, edgecolor = 'k')
rects5 = ax1.bar(index + bar_width*4, means_DQNPre, bar_width, alpha=opacity, color=c[14], label='DQNPre', yerr = std_DQNPre, edgecolor = 'k')
rects6 = ax1.bar(index + bar_width*5, means_NN, bar_width, alpha=opacity, color=c[15], label='DNN',yerr = std_NN, edgecolor = 'k')
rects7 = ax1.bar(index + bar_width*6, means_graphnet, bar_width, alpha=opacity, color=c[16], label='Graphnet', yerr=std_graphnet, edgecolor = 'k')
ax1.set_xlabel('')
...
rects3 = ax2.bar(index + bar_width*2, means_DORAc, bar_width, alpha=opacity, color=c[3], label='CLEVR_DORA', yerr = std_DORAc, edgecolor = 'k')
rects4 = ax2.bar(index + bar_width*3, means_DQN, bar_width, alpha=opacity, color=c[13], label='DQN', yerr = std_DQN, edgecolor = 'k')
rects5 = ax2.bar(index + bar_width*4, means_DQNPre, bar_width, alpha=opacity, color=c[14], label='DQNPre', yerr = std_DQNPre, edgecolor = 'k')
rects6 = ax2.bar(index + bar_width*5, means_NN, bar_width, alpha=opacity, color=c[15], label='DNN', yerr = std_NN, edgecolor = 'k')
rects7 = ax2.bar(index + bar_width*6, means_graphnet, bar_width, alpha=opacity, color=c[16], label='graphnet', yerr = std_graphnet, edgecolor = 'k')
...
rects3 = ax3.bar(index + bar_width*2, means_DORAc, bar_width, alpha=opacity, color=c[3], label='CLEVR_DORA',yerr=std_DORAc, edgecolor = 'k')
rects4 = ax3.bar(index + bar_width*3, means_DQN, bar_width, alpha=opacity, color=c[13], label='DQN', edgecolor = 'k')
rects5 = ax3.bar(index + bar_width*4, means_DQNPre, bar_width, alpha=opacity, color=c[14], label='DQNPre', edgecolor = 'k')
rects6 = ax3.bar(index + bar_width*5, means_NN, bar_width, alpha=opacity, color=c[15], label='DNN', edgecolor = 'k')
rects7 = ax3.bar(index + bar_width*6, means_graphnet, bar_width, alpha=opacity, color=c[16], label='graphnet', edgecolor = 'k')
