...
#rects1 = ax1.bar(index, means_human, bar_width, alpha=opacity, color=c[6], label='Humans', yerr = std_humans, edgecolor = 'k')
...
opacity = 1.0
error_config = {'ecolor': '0.3'}
#rects1 = ax2.bar(index, means_human, bar_width, alpha=opacity, color=c[6], label='Humans', yerr = std_human, edgecolor = 'k')
...
ax2.set_title('')
ax2.set_xticks(index + bar_width*6 / 2)
...
opacity = 1.0
error_config = {'ecolor': '0.3'}
#rects1 = ax3.bar(index, means_human, bar_width, alpha=opacity, color=c[6], label='Humans', yerr = std_human, edgecolor = 'k')
