...
rel_ql_fox = RelationalQLearningAgent(env, 'Breakout', num_episodes=1000,
                                      decay_steps_lr=1000, decay_steps_epsilon=1000,
                                      discount_factor=0.99,
                                      i_alpha=0.1, f_alpha=0.05,
                                      i_epsilon=0.1, f_epsilon=0.01)
...
#
# fig.tight_layout()
# fig.savefig('tabular_RL_results_1000_e_1_to_0.05_1000_lr_0.1.pdf')
# # plt.show()

# Load q_dic
rel_ql_fox.load_qdic('q_dic_best.txt')


# Test agent
rel_ql_fox.current_epsilon = 0.01
rel_ql_fox.test_agent(100, render=False)
